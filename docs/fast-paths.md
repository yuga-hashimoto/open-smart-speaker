...
| `AlarmMatcher` | "set an alarm for 7am", "wake me up at 6:30", "7時にアラーム", "目覚まし" | `set_timer` (seconds-until-wall-clock) | Rolls past times to tomorrow; sits after TimerMatcher |
