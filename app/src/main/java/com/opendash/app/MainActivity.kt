...
import com.opendash.app.assistant.provider.embedded.ModelDownloadState
...
class MainActivity : ComponentActivity() {
    ...
    @javax.inject.Inject lateinit var cameraProviderHolder: com.opendash.app.tool.system.CameraProviderHolder
    @javax.inject.Inject lateinit var screenRecorderHolder: com.opendash.app.tool.system.ScreenRecorderHolder
    @javax.inject.Inject lateinit var toolExecutor: com.opendash.app.tool.ToolExecutor
    @javax.inject.Inject lateinit var routineShortcutPublisher: com.opendash.app.shortcuts.RoutineShortcutPublisher

    private lateinit var intentCameraProvider: com.opendash.app.tool.system.IntentCameraProvider
    private lateinit var screenRecorder: com.opendash.app.tool.system.MediaProjectionScreenRecorder
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        intentCameraProvider = com.opendash.app.tool.system.IntentCameraProvider(this)
        cameraProviderHolder.setProvider(intentCameraProvider)

        screenRecorder = com.opendash.app.tool.system.MediaProjectionScreenRecorder(this)
    ...
    private fun handleRoutineShortcut(intent: Intent) {
        val id = intent.getStringExtra(
            com.opendash.app.shortcuts.RoutineShortcutPublisher.EXTRA_ROUTINE_ID
        )?.takeIf { it.isNotBlank() } ?: return
        // Clear so configuration changes don't re-fire.
        intent.removeExtra(com.opendash.app.shortcuts.RoutineShortcutPublisher.EXTRA_ROUTINE_ID)
