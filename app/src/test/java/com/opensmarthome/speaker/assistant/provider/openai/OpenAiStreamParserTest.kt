package com.opensmarthome.speaker.assistant.provider.openai
...
class OpenAiStreamParserTest {
    ...
    fun `parseFullResponse extracts assistant message`() {
        ...
        val assistant = result as? com.opensmarthome.speaker.assistant.model.AssistantMessage.Assistant
